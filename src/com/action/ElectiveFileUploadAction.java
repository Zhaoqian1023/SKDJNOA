...
public class ElectiveFileUploadAction extends ActionSupport {
    ...
    public String execute() throws FileNotFoundException{
        ...
        //获取要保存文件夹的物理路径(绝对路径)
        String realPath=ServletActionContext.getServletContext().getRealPath("/manager/upload_select");
        ...
        try {
        	...
        	String newFileName ="ElectiveStudent"+sdf.format(date)+".xls";
    		...
    		result = PublicElectiveService.addElectiveStudent(data, years);
    		if(result){
    			...
    			Log log = new Log("", management.getMid(), management.getMname(),
    					years + "", data.get(1).get(1).toString(), "选课学生信息导入", "管理员");
