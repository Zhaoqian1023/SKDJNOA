...
public class SelectFileUploadAction extends ActionSupport {
    ...
    public String execute() throws FileNotFoundException{
        ...
        try {
        	...
        	String newFileName ="SelectCourse"+sdf.format(date)+".xls";
    		...
    		result = PublicCourseService.addSelectCoursePlan(data, years);
    		if(result){
