...
public class SaveTemp {
	...
	public SaveTemp(int stId, String className, String classId, String years,
			String courseName, String studentId, String studentName,
			String ordinaryScore, String paperScore, String remark,
			String ordinaryProportion, String paperProportion, String credit,
			String courseCategory, String flag, String finalScore,
