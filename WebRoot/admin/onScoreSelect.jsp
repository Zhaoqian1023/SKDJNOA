                 ...
                 <i class="fa fa-hand-o-down"> </i> <span
                   ...
                   <table align="center">
                   	<tr>
                   		...
                   		<th width="30%"  style="text-align:center;font-size: 25px">打印方式</th>
                   	</tr>
                       ...
                       <tr>
                    	...
                    	<td width="30%" align="center" >
	                    	...
	                    	<a href='Source_query?page=courseandattendancegradefinal&year=2017-2018/2&courseId=${att.getCourseId() }&classId=${att.getClassId()}'><input type="submit" value='平时成绩单打印' ></a>
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
