                   ...
                   <table align="center">
                       ...
                       <tr>
                    	...
                    	<td width="30%" align="center" >
	                    	<a href="Print_printFunctionasinput?page=scoreinput&status=在校&fangshi=百分制&kcdm=${att.getCourseId() }&bjdm=${att.getClassId()}"><input type="submit" value='百分制录入' ></a>&nbsp;&nbsp;&nbsp;	                    	
	                    	<a href="Print_printFunctionasinput?page=scorekccinput&status=在校&fangshi=五级记分制&kcdm=${att.getCourseId() }&bjdm=${att.getClassId()}"><input type="submit" value='五级记分制录入' ></a>
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
