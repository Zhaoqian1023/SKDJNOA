                 ...
                 <i class="fa fa-hand-o-down"> </i> <span
                   ...
                   <table align="center">
                   	<tr>
                   		...
                   		<th width="40%"  style="text-align:center;font-size: 25px">打印方式</th>
                   	</tr>
                   	<tr><td><br></td></tr>
                   	<tr><td><br></td></tr>
                       ...
                       <tr>
                    	...
                    	<td width="20%" align="center" >
	                    	<a href="Source_queryByCourse?page=coursegradefinalall&year=2017-2018/2&courseId=${att.getCourseId() }"><input type="submit" value='最终成绩单打印' ></a>&nbsp;&nbsp;&nbsp;                    	
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
