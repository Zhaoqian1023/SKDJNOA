									...
									<table align="center" border="0" style="border-spacing: 100px">
										...
										<tr>
											...
											<td width="40%"><input type="text"
												...
												placeholder="0-100" value="${listST.get(0).getOrdinaryProportion() }" onkeyup="KeyP(this)"><span>%</span></td>
										</tr>
										<tr>
											<td><span class="btn-info" style="font-size: medium">卷面成绩权重：</span></td>
											<td><input type="text" name="paperProportion" id="txt"
												size="5" placeholder="0-100" value="${listST.get(0).getPaperProportion() }" readonly="true"><span>%</span></td>
										</tr>
										<tr>
											<td><br></td>
										</tr>
														...
														<tbody>
															<tr valign="middle" align="left">
																...
																<td height="24" width="40%" nowrap="nowrap" align="left">学年/学期：<input
																	...
																	style="border: 0px" value="${listST.get(0).getYears() }"></td>
															</tr>
															<tr valign="middle" align="left">
																				...
																				<tr class="Font8Pt" valign="top">
																					...
																					<td id="xianshi3" class="RULine" name="final1"
																						...
																						name="finalGrade" id="rank">
																							<option value="${att.getFinalScoreNum() }">${att.getFinalScore() }</option>
