...
<script type="text/javascript">
	...
	function checkAction(n){
		if(n == 0){
			document.formName.action="Source_savekccGX?page=save&flag=五级记分制";
		}else if(n == 1){
			document.formName.action="Source_addkccGX?page=input";
		}
		dbform.submit();
	}
</script>
												...
												<table class="Font11PtX120" width="100%" cellspacing="0"
													...
													<tbody>
														<tr valign="middle" align="left">
															<td height="24" width="60%" nowrap="nowrap" align="left">课程名称：<input type="text" name="course" size="25" readonly="readonly" style="border: 0px" value="${list.get(0).getCourseName() }"></td>
																	...
																	<tbody>
																		...
																		<tr class="Font8Pt" valign="top">
																			...
																			<td class="RULine" nowrap="nowrap" align="center">
																				...
																				<input type="text" style="display: none" name="classid" value="${att.getClassId() }">
																			</td>
