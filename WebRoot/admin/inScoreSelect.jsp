                 ...
                 <i class="fa fa-hand-o-down"> </i> <span
                   ...
                   <table align="center">
                   	<tr>
                   		...
                   		<th width="30%"  style="text-align:center;font-size: 25px">班级</th>
                   		<th width="30%"  style="text-align:center;font-size: 25px">录入方式</th>
                   	</tr>
                   	<c:forEach items="${VOList}" var="att">
                       <tr>
                        <td width="40%" align="center" style="font-size: 20px">${att.getCourseName() }</td>
                    	<td width="30%" align="center" style="font-size: 20px">${att.getClassName() }</td>
                    	<td width="30%" align="center" >
	                    	<a href="Print_printFunctionasinput_select?page=scoreinput&status=在校&fangshi=百分制&kcdm=${att.getCourseId() }&bjdm=${att.getClassId()}"><input type="submit" value='百分制录入' ></a>&nbsp;&nbsp;&nbsp;	                    	
	                    	<a href="Print_printFunctionasinput_select?page=scorekccinput&status=在校&fangshi=五级记分制&kcdm=${att.getCourseId() }&bjdm=${att.getClassId()}"><input type="submit" value='五级记分制录入' ></a>
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
