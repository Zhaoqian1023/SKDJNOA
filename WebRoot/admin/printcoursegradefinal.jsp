					...
					<table class="Font11PtX120" width="100%" cellspacing="0"
						...
						<tbody>
							<tr valign="middle" align="left">
								...
								<td height="18" nowrap="nowrap" align="left" style="width:300px">班号：${list.get(0).getClassId() }
								</td>
								<td height="18" width="40%" nowrap="nowrap" align="left">学年/学期：${list.get(0).getYear() }</td>
							</tr>
							<tr valign="middle" align="left">
								<td height="18" nowrap="nowrap" align="left" style="width:400px">课程名称：${list.get(0).getCourse() }</td>
