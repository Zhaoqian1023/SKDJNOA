                ...
                <header class="panel-heading">
                 <i class="fa fa-hand-o-down"> </i> <span
                   ...
                   <table align="center">
                       ...
                       <tr>
                        <td width="50%"  style="font-size: 20px">${att.pname }</td>
                    	<td width="50%"  >
	                    	<a href="Print_printSelect?bjdm=${bjdm }&kcdm=${att.pid }&page=attendance_select&status=在校"><input type="submit" value='考勤表' ></a>&nbsp;&nbsp;&nbsp;	                    	
	                    	<a href="Print_printSelect?bjdm=${bjdm }&kcdm=${att.pid }&page=regulargrade_select&status=在校"><input type="submit" value='平时成绩单' ></a>&nbsp;&nbsp;&nbsp;
	                    	<a href="Print_printSelect?bjdm=${bjdm }&kcdm=${att.pid }&page=coursegrade_select&status=在校"><input type="submit" value='最终成绩单' ></a>
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
