						...
						<div class="col-lg-12">
							<section class="panel">
									...
									<table align="center" border="0" style="border-spacing: 100px">
										...
										<tr>
											...
											<td width="40%"><input type="text"
												...
												placeholder="0-100"
												value="${listST.get(0).getOrdinaryProportion() }"
												onkeyup="KeyP(this)"><span>%</span></td>

										</tr>
										<tr>
											<td><span class="btn-info" style="font-size: medium">卷面成绩权重：</span></td>
											<td><input type="text" name="paperProportion" id="txt"
												size="5" placeholder="0-100"
												value="${listST.get(0).getPaperProportion() }"
												readonly="true"><span>%</span></td>
										...
										<div id="f3" align="center"
											...
											<tr align="center" style="display: block">
												...
												<td><input type="text" style="display: none"
													name="courseId" value="${listST.get(0).getCourseId() }">
													<input type="text" style="display: none" name="examFlag"
													value="${listST.get(0).getExamFlag() }"></td>
											</tr>
											<tr>
												<td><br></td>
											</tr>
																	...
																	<table class="LUpLines" id="mm" onkeydown="keyDown(event)" width="100%" cellspacing="0"
																		...
																		<tbody>
																			<tr class="Font11PtX120" valign="middle"
																				...
																				<td style="display: none" class="RULine"
																					id="xianshi2" class="xianshia" width="22%"
																					nowrap="nowrap">最终成绩</td>
																			...
																			<c:forEach items="${listST}" var="att">
																				<tr class="Font8Pt" valign="top">
																					<td class="RULine"><center>
																							<input type="text" size="12" name="studentId"
																								readonly="readonly" style="border: 0px"
																								value="${att.getStudentId() }">
																						</center></td>
																					<td class="RULine" nowrap="nowrap"><center>
																							<input type="text" name="studentName" size="5"
																								readonly="readonly" style="border: 0px"
																								value="${att.getStudentName()}">
																						</center></td>
																					<td class="RULine" nowrap="nowrap" align="center">
																						<input 
																						name="ordinaryGrade" id="p2" class="ping"
																						type="text" size="5" autocomplete="off"
																						value="${att.getOrdinaryScore() }" placeholder="" />
																					</td>
																					<td class="RULine" nowrap="nowrap" align="center">
																						<input  name="paperGrade"
																						value="${att.getPaperScore() }" id="j2"
																						class="juan" type="text" size="5" autocomplete="off" placeholder="" />
																					</td>
													...
													<table width="85%" border="1" align="center"
														...
														<tr>
															...
															<td nowrap="nowrap"><input readonly="true"
																style="border: 0px" id="you1" size="5" readonly="true">%</td>
															<td nowrap="nowrap"><input readonly="true"
																style="border: 0px" id="liang1" size="5" readonly="true">%</td>
															<td nowrap="nowrap"><input readonly="true"
																style="border: 0px" id="zhong1" size="5" readonly="true">%</td>
															<td nowrap="nowrap"><input readonly="true"
																id="jige1" style="border: 0px" size="5" readonly="true"
																onclick="alert(FormatAfterDotNumber(docment.all.strTemp.value),2)">%</td>
															<td nowrap="nowrap"><input readonly="true"
																style="border: 0px" id="notjige1" size="5"
																readonly="true">%</td>
								...
								<div id="f2" style="display: block;">
									<table align="center">
										<tr>
											<td width="100px" style="float: left"><span name="boo"
												type="submit" class="btn btn-primary"
												style="font-size: medium;align-self: center">统计</span>
												<h5>
													<br>
												</h5></td>
											<td width="100px">
												...
												<button class="btn btn-primary" data-toggle="modal"
													data-toggle="modal" data-target="#mymodaltwo" type="button">保存</button>
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button class="btn btn-success" type="submit"
													onclick="checkAction(0);">确认提交</button>
								...
								<div class="modal fade" id="mymodal-data"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button class="btn btn-success" type="submit"
													onclick="checkAction(1)">确认提交</button>
										...
										<div class="modal-content">
											...
											<div class="modal-body" style="padding: 30px 50px 50px;">
												<div class="text-danger"
													...
													<table align="center">
														<tr>
															<td>一、平时成绩比例为必填项（范围为“0-100”，无平时成绩比例则输入“0”），在输入成绩时成绩范围为“0-100”，禁止出现空格、汉字、字母、符号等情况
																。</span>
															</td>
														</tr>
														<tr>
