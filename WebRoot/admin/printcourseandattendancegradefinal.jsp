				...
				<td>
					<table width="750" border="1" align="center" cellpadding="0"
						...
						<tr>
							...
							<td nowrap="nowrap"><center><font size="2">${cr.getStu1() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getStu2() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getStu3() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getStu4() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getStu5() }</font></center></td>
							<td nowrap="nowrap" rowspan="2"><center><font size="2">${cr.getOrdinaryProportion()}</font></center></td>
							<td nowrap="nowrap" rowspan="2"><center><font size="2">${cr.getPaperProportion() }</font></center></td>
							<td nowrap="nowrap" rowspan="2"><center><font size="2">${cr.getAvg() }</font></center></td>
						</tr>
						<!--!!!!请看这里!!!!td中的空格不能去除，ie中td无内容就不显示下框线-->
						<tr>
							<td nowrap="nowrap"><font size="2">百分数</font></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getS1() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getS2() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getS3() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getS4() }</font></center></td>
							<td nowrap="nowrap"><center><font size="2">${cr.getS5() }</font></center></td>
							<!--<td nowrap="nowrap">&nbsp;</td>-->
