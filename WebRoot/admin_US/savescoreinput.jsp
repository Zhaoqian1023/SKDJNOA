...
<body onload="active()">
									...
									<table align="center" border="0" style="border-spacing: 100px">
										...
										<tr>
											...
											<td width="40%"><input type="text"
												...
												placeholder=""
												value="0"
												onkeyup="KeyP(this)" readonly="readonly"><span>%</span></td>
																			...
																			<c:forEach items="${listST}" var="att">
																				<tr class="Font8Pt" valign="top">
																					...
																					<td class="RULine" nowrap="nowrap" align="center" style="display: none;">
																						<input 
																						name="ordinaryGrade" id="p2" class="ping" autocomplete="off"
																						type="text" size="5" style="text-align:center;border: 0px;" readonly="readonly" value="0"
																						/>
																					</td>
																					<td class="RULine" nowrap="nowrap" align="center">
																						<input  name="paperGrade" autocomplete="off"
																						value="${att.getPaperScore() }" id="j2" style="text-align:center"
																						class="juan" type="text" size="5" placeholder="" />
																					</td>
										...
										<tr>
											<td width="100px">
												...
												<button class="btn btn-primary" data-toggle="modal"
													data-toggle="modal" data-target="#mymodaltwo" type="button">Save</button>
											...
											<td style="margin-left: 100px">
												...
												<button class="btn btn-primary" data-toggle="modal"
													...
													type="button">Confirm Entry (can not be changed)</button>
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button class="btn btn-success" type="submit"
													onclick="checkAction(0);">Confirm Submission</button>
								...
								<div class="modal fade" id="mymodal-data"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button class="btn btn-success" type="submit"
													onclick="checkAction(1)">Confirm Submission</button>
	...
	<!-- COUNT JS -->
	<script src="js/changeKeyForSave.js"></script>
