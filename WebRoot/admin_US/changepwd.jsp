	...
	<section id="container" class="">
				...
				<section class="panel" >
					<header class="panel-heading">
						<i class="fa fa-smile-o"> </i> <span class="label label-primary"
							style="font-size: medium"> Change Password </span>
					...
					<form method="post" action="Users_update?page=changepwd">
						<div class="modal-dialog" >
							<div class="modal-content">
								...
								<div class="modal-body" style="padding: 100px 100px 10px;width:800px">
							<!--		<form class="form-horizontal" role="form">-->
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> Enter new password:&nbsp&nbsp&nbsp&nbsp&nbsp
											</label> <input id="pwd1" name="name" minlength="6" type="password"
												required>
										</div>
										<div width="100px" height="20px" style="margin-top: 20px">
											<label for="name" style="font-size: medium">Re-enter new password: </label>
											<input id="pwd2" name="newpassword" minlength="6" type="password"
												onkeyup="validate()" required><span id="tishi"></span>
										</div>
									<div class="modal-footer">
									<button class="btn btn-default" type="submit">Submit</button>
									<a href="login.jsp"><button class="btn btn-success" type="button">Cancel</button></a>
								</div>
								<!-- 	 </form>-->
								</div>
		...
		<script>
			...
			function validate() {
				...
				// 对比两次输入的密码 
				if (pwd1 == pwd2) {
					document.getElementById("tishi").innerHTML = "<font color='green'>Successful!</font>";
					document.getElementById("submit").disabled = false;
					return true;
				} else {
					document.getElementById("tishi").innerHTML = "<font color='red'>These passwords don't match. Try again?</font>";
