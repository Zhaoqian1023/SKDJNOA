                 ...
                 <i class="fa fa-hand-o-down"> </i> <span
                   ...
                   <table align="center">
                   	<tr>
                   		...
                   		<th width="30%"  style="text-align:center;font-size: 25px">Printing Method</th>
                   	</tr>
                   	<c:forEach items="${VOList}" var="att">
                       <tr>
                        <td width="30%" align="center" style="font-size: 20px">${att.getCourseName() }</td>
                    	<td width="30%" align="center" style="font-size: 20px">${att.getEnglishName() }</td>
                    	<td width="40%" align="center" >
	                    	<a href="Source_query?page=coursegradefinal&year=2017-2018/2&courseId=${att.getCourseId() }&classId=${att.getClassId()}"><input type="submit" value='Print - Final Transcript' ></a>&nbsp;&nbsp;&nbsp;                    	
	                    	<%-- <a href='Source_query?page=courseandattendancegradefinal&year=2016-2017/2&course=${att.getCourseName() }&className=${att.getClassName()}'><input type="submit" value='平时成绩单打印' ></a>--%>
	                    	</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
