					...
					<table class="Font11PtX120" width="100%" cellspacing="0"
						...
						<tbody>
							<tr valign="middle" align="left">
								<td height="18" width="40%" nowrap="nowrap" align="left">Class: ${list.get(0).getClassEnglish() }
								</td>
								<td height="18" nowrap="nowrap" align="left">Class Number: ${list.get(0).getClassId() } &nbsp&nbsp
								</td> 
							...
							<tr valign="middle" align="left">
								...
								<td height="18" nowrap="nowrap" align="left">Course Type: ${list.get(0).getCategory() }
								</td>
							</tr>
						</tbody>
					</table>
										...
										<tbody>
											<tr class="Font11PtX120" valign="middle" align="center">
												<td height="18" class="RULine" width="5%" nowrap="nowrap"
													style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid">No.</td>
												<td height="18" class="RULine" width="30%" nowrap="nowrap"
													style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">Student ID</td>
												<td height="18" class="RULine" width="25%" nowrap="nowrap"
													style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">Name</td>
												<td height="18" class="RULine" width="25%" nowrap="nowrap"
													style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">Grade</td>
												<td height="18" class="RULine" width="15%" nowrap="nowrap"
													style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">Remarks</td>
											</tr>
											<c:choose>
													...
													<c:forEach items="${list}" var="att" varStatus="status">
														<tr class="Font8Pt" valign="top" align="center">
															...
															<td height="21" class="RULine" nowrap="nowrap"
																valign="middle"
																style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font
																size="2">${att.getSid() }</font></td>
															<td height="21" class="RULine" nowrap="nowrap"
																valign="middle"
																style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font
																size="2">${att.getEnglishName() }</font></td>
															<td height="21" class="RULine" nowrap="nowrap"
																valign="middle"
																style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font
																size="2">&nbsp;</font></td>
														...
														<tbody>
															...
															<s:if test="%{list.size()>35}">
																<c:forEach items="${list}" var="att" begin="35"
																	...
																	<tr class="Font8Pt" valign="top">
																		<td height="21" class="RULine" align="center"><font
																			size="2">${status.count+35}</font></td>
																		<td height="21" class="RULine" nowrap="nowrap"><font
																			size="2">${att.getSid() }</font></td>
																		<td height="21" class="RULine" nowrap="nowrap"><font
																			size="2">${att.getEnglishName() }</font></td>
																		<td height="21" class="RULine" nowrap="nowrap"><font
				...
				<td>
					<table width="750" border="1" align="center" cellpadding="0"
						...
						<tr>
							...
							<td nowrap="nowrap">90～100</td>
							<td nowrap="nowrap">80～89</td>
							<td nowrap="nowrap">70～79</td>
							<td nowrap="nowrap">60～69</td>
							<td nowrap="nowrap">50～59</td>
							<td nowrap="nowrap">小于50</td>
			...
			<tr>
				...
				<table width="40%" border="0" align="center" valign="middle"
					...
					<tr>
						...
						<td><a href="queryinfo.jsp" style='text-decoration:none;'>
								<button type="button" class="btn btn-primary">Return</button>
						</a></td>
						<td>
							<button type="button" class="btn btn-danger" onclick="preview(1)">Print</button>
