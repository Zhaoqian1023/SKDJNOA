					...
					<table class="Font11PtX120" width="100%" cellspacing="0"
						...
						<tbody>
							<tr valign="middle" align="left">
								...
								<td height="18" nowrap="nowrap" align="left" >班号：${list.get(0).getClassId() } &nbsp&nbsp
								</td>
								<td height="18" width="40%" nowrap="nowrap" align="left">学年/学期：${list.get(0).getYear() }</td>
							</tr>
							<tr valign="middle" align="left">
								<td height="18" nowrap="nowrap" align="left">课程名称：${list.get(0).getCourse() } &nbsp&nbsp</td>
													...
													<c:forEach items="${list}" var="att" varStatus="status">
														<tr class="Font8Pt" valign="top">
															...
															<td height="21" class="RULine" nowrap="nowrap"
																...
																<c:if
																	test="${att.getFinalGrade() >= 50.0}">
																	<center>
																		<font size="2">${att.getFinalGrade() }</font>
																	</center>
																</c:if> <c:if test="${att.getFinalGrade() < 50.0}">
																	<center>
																		<font size="2"
