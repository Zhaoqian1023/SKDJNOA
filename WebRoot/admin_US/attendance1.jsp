...
<!-- END SHORTCUT ICON -->
<title>山东科技大学济南校区学生上课考勤表查询</title>
				...
				<section class="panel">
					<header class="panel-heading">
						<i class="fa fa-hand-o-down"> </i> <span
							...
							Please select the form to be printed </span>
					</header>
					<div class="panel-body">
						<form action="Print_printFunction?page=attendance&status=在校" method="post">
							...
							<button type="submit" class="btn btn-primary">Print preview</a></button>
						</form>
				</section>
				<br>
				<br>
