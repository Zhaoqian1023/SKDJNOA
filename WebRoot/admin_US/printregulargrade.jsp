				...
				<td>
					<table class="Font12" width="100%" border="0" align="center">
						<tbody>
							...
							<tr valign="top">
								<td nowrap="nowrap"><font color="#FF0000"><strong>Disclaimer：</strong></font></td>
									...
									<table class="LUpLines" width="100%" cellspacing="0"
										...
										<tbody>
											<tr class="Font11PtX120" valign="middle" align="center">
												<td height="24" class="RULine" width="4%" nowrap="nowrap"><font size="2">No</font></td>
												<td height="24" class="RULine" width="17.5%" nowrap="nowrap"><font size="2">Student ID</font></td>
												<td height="24" class="RULine" width="17.5%" nowrap="nowrap"><font size="2">Name</font></td>
												<td height="24" class="RULine" width="48%" nowrap="nowrap" colspan="5"
													valign="middle" align="center"><font size="2">Regular Grade</font></td>

											</tr>
											<c:forEach items="${list}" var="att" varStatus="varstatus">
											<tr align="center">
												<td height="18" noWrap><font size="3">${varstatus.count }</font></td>
												<td height="18" noWrap><font size="3">${att.getSid() }</font></td>
												<td height="18" noWrap><font size="3">${att.getEnglishName() }</font></td>
												<td></td>
												<td></td>
												<td></td>
												<td></td>
						...
						<td>
							<center>
								<button type="button" class="btn btn-danger"
									onclick="preview(1)">Print</button>
