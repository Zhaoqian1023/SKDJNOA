			...
			<!-- START ROW -->
                ...
                <header class="panel-heading">
                 <i class="fa fa-hand-o-down"> </i> <span
							...
							Please select the course to be printed </span>
                </header>
                    <br>
                    &nbsp;   &nbsp; &nbsp; &nbsp; &nbsp; 
                   ...
                   <table align="center">
                   	<tr>
                   		...
                   		<th width="50%"  style="text-align:center;font-size: 25px">Course</th>
                   		<th width="50%"  style="text-align:center;font-size: 25px">Print</th>
                   	</tr>
                   	<c:forEach items="${clist}" var="att">
                       <tr>
                        <td width="50%"  style="font-size: 20px">${att.cname }</td>
                    	<td width="50%"  >
	                    	<a href="Print_printFunction?bjdm=${bjdm }&kcdm=${att.cid }&page=attendance&status=在校"><input type="submit" value='Attendance Sheets' ></a>&nbsp;&nbsp;&nbsp;	                    	
	                    	<a href="Print_printFunction?bjdm=${bjdm }&kcdm=${att.cid }&page=regulargrade&status=在校"><input type="submit" value='Regular Grade' ></a>&nbsp;&nbsp;&nbsp;
	                    	<a href="Print_printFunction?bjdm=${bjdm }&kcdm=${att.cid }&page=coursegrade&status=在校"><input type="submit" value='Final Transcript' ></a>
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
