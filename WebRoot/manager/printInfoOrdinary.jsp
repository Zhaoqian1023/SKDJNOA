                 ...
                 <i class="fa fa-hand-o-down"> </i> <span
                   ...
                   <table align="center">
                   	<tr>
                   		...
                   		<th width="50%"  style="text-align:center;font-size: 25px">操作方式</th>
                   	</tr>
                   	<c:forEach items="${clist}" var="att">
                       <tr>
                        <td width="50%" align="center"  style="font-size: 20px">${att.cname }</td>
                    	<td width="50%"  align="center" >
	                    	<a href="Source_deleteaAll?bjdm=${bjdm }&kcdm=${att.cid }"><input type="submit" value='删除成绩' ></a>&nbsp;&nbsp;&nbsp;	                    	
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
                    <c:forEach items="${pclist}" var="att">
                       <tr>
                        <td width="50%" align="center"  style="font-size: 20px">${att.pname }</td>
                    	<td width="50%"  align="center" >
	                    	<a href="Source_deleteaAll?bjdm=${bjdm }&kcdm=${att.pid }"><input type="submit" value='删除成绩' ></a>&nbsp;&nbsp;&nbsp;	                    	
						</td>
                        </tr>
                        <tr><td><br></td></tr>
                    </c:forEach>
