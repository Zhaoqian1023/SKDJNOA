...
<!-- END SHORTCUT ICON -->
<title>山东科技大学济南校区课程成绩录入班级查询</title>
	...
	<section id="container" class="">
				...
				<section class="panel">
					<header class="panel-heading">
						<i class="fa fa-hand-o-down"> </i> <span
							...
							请选择需要删除成绩的班级及课程 </span>
					</header>
					<div class="panel-body">
						<form action="Source_deleteaAll?page=classfind_manager&year=2016-2017/2" method="post">
							<select name="zy" id="s1" style="width:20%; height:30px;">
								<option></option>
							</select> <select name="nj" id="s2" style="width:20%;height:30px;">
								<option></option>
							</select> <select name="className" id="s3" onmouseout="getKCM()"
								style="width:20%;height:30px;">
								<option></option>
							</select> <select name="course" id="s4" style="width:20%;height:30px;">
								<option></option>
							</select>
							<br> <br>
									...
									<div class="modal-content">
										...
										<div class="modal-body" style="padding: 100px 100px 10px;">
											<div class="text-danger"
												style="font-size: medium;margin: auto">请再次确班级以及课程后再删除，以免数据丢失！</div>
										</div>
		...
		<script type="text/javascript">
			function getKCM() {
				...
				var msg = "professional=" + professional +"&years=2016-2017/2" + "&category=非公选" ;
				$.ajax({
					type : "post",
