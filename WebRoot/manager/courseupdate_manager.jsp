			...
			<section class="wrapper">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<form method="post" action="Course_updateCourseByCid">
									...
									<div class="modal-body" style="padding: 100px 100px 10px;">
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 课程代码: </label> <input
												name="cid1" readonly="readonly" value="${course.cid }" type="text">
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 课程名称: </label> <input
												name="cname1" value="${course.cname }" type="text">
										</div>
										<div width="100px" height="25px">
										...
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium">
												学&nbsp;&nbsp;时: </label> <input name="time1" value="${course.time }" type="text">
										</div>
										...
										<div width="100px" height="25px">
											...
											<select name="beginTime1" style="width:40%; height:25px;">
												<option value="${course.beginTime }">${course.beginTime }</option>
										...
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 结课周: </label> 
												...
												<option value="${course.endTime }">${course.endTime }</option>
												<%@ include file="publicpage/week_option.jsp"%>
											</select>
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 教师工号: </label> <input
												name="teachers1" value="${course.getTeachers().getTid() }" type="text">
										</div>
										...
										<div width="100px" height="25px">
											...
											<select name="examFlag1" style="width:40%; height:25px;">
											    <option value="${course.examFlag }">${course.examFlag }</option>
												<%@ include file="publicpage/week_option.jsp"%>
											</select>
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 上课班级: </label> <input
												name="classId" value="" placeholder="如：152041,152042,152043" type="text">
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 课程编码: </label> <input
												name="courseNum1" value="${course.courseNum }"  type="text">
										</div>
