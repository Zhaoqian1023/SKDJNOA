			...
			<section class="wrapper">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<form method="post" action="Course_addCourse">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body" style="padding: 100px 100px 10px;">
										...
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium">
												学&nbsp;&nbsp;时: </label> <input name="time1" placeholder="例：48" type="text">
										</div>
										...
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 教师工号: </label> <input
												name="teachers1" placeholder="例：2400" type="text">
										</div>
										...
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 上课班级: </label> <input
												name="classId" placeholder="如：152041,152042,152043" type="text">
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 课程编码: </label> <input
												name="courseNum" placeholder="八位课程编码" type="text">
										</div>
