			...
			<section class="wrapper">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<form method="post" action="PublicElective_getStudentByCourse">
									...
									<div class="modal-body" style="padding: 100px 100px 10px;">
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 课程代码: </label> <input
												name="courseId" readonly="readonly" value="${PCourse.pid }" type="text">
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 课程名称: </label> <input
												name="kcm" readonly="readonly" value="${pCourse.getPname() }" type="text">
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 课程类别: </label> 
											<input
												name="category1" readonly="readonly" value="${pCourse.getCategory() }" type="text">
										...
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium">
												学&nbsp;&nbsp;分: </label>
											<input
												name="credits1" readonly="readonly" value="${pCourse.getCredits() }" type="text">
											
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium">
												学&nbsp;&nbsp;时: </label> 
											<input name="time1" readonly="readonly" value="${pCourse.getTime() }" type="text">
										</div>

										<div width="100px" height="25px">	
											<label for="name" style="font-size: medium">
												学&nbsp;&nbsp;期: </label>
											<input name="year1" readonly="readonly" value="${pCourse.getYear() }" type="text">

										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 开课周: </label>
											<input name="beginTime1" readonly="readonly" value="${pCourse.getBeginTime() }" type="text">
												
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 结课周: </label> 
											<input name="endTime1" readonly="readonly" value="${pCourse.getEndTime() }" type="text">
										</div>
										<div width="100px" height="25px">
											<label for="name" style="font-size: medium"> 教师工号: </label> 
											<input
												name="teachers1" readonly="readonly" value="${pCourse.getTeachers().getTid() }" type="text">
										</div>
										...
										<div width="100px" height="25px">
											...
											<input
												name="examFlag1" readonly="readonly" value="${pCourse.getExamFlag() }" type="text">
										</div>
										<div class="modal-footer">
											<button class="btn btn-default" type="submit">导出选课学生</button>
										</div>
									</div>
