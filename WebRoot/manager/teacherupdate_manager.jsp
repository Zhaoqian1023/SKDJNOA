<%@ page language="java" import="java.util.* ,com.po.Teacher"
	pageEncoding="UTF-8"%>
				...
				<section class="panel">
					<header class="panel-heading">
						<i class="fa fa-hand-o-down"> </i> <span
							class="label label-primary" style="font-size:medium"> 教师信息</span>
					</header>
					<div class="panel-body">
						<form method="post" action="Teacher_updateTeacher">
									...
									<div class="modal-body" style="padding: 100px 100px 10px;">
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 教师工号: </label> <input
												name="tid" value="${teacher.getTid()}" type="text"
												readonly="readonly">
										</div>
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 教师姓名: </label> <input
												name="tname" value="${teacher.getTname()}" type="text">
										</div>
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 所属教研室: </label>
											<!--  <input name="position" value="${teacher.getPosition() } "  type="text">
											-->
											<select name="position">
												<option value="${teacher.getPosition() }">${teacher.getPosition() }</option>
										...
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 职称: </label>
											<!--  <input name="title" value="${teacher.getTitle() }"  type="text">
											-->
											<select name="title">
												<option value="${teacher.getTitle() }">${teacher.getTitle() }</option>
										...
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 所在单位: </label>
											<!-- <input name="dname" value="${teacher.getDept().getDname() }"  type="text">
											-->
											<select name="dname">
												<option value="${teacher.getDept().getDname() }">${teacher.getDept().getDname() }</option>
