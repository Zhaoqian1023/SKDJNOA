...
<html>
                    ...
                    <section class="panel">
                        ...
                        <div class="form-group has-success" align="center">
                            <form action="" class="form-horizontal" role="form">
                                <table border="0">
                                    <tr>
                                        <td width="50%"> <span class="btn-info" style="font-size: 25px"  >请输入学生学号：</span></td>
                                        <td width="50%"> <input type="text" class="form-control" name="studentId" id="studentId" size="10"></td>
 ...
 $(function(){
     $("#modale").click(function(){
			...
			var loginInfo = "studentId=" + studentId;
			$("#loginBtn").attr("value", "登录中..");
			if (studentId != "") {
				$.ajax({
					type : "post",
					url : "Manager_forgetStudentPwd.action",
					data : loginInfo,
					async : false,
