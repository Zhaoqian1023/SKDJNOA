									...
									<div class="modal-body" style="padding: 100px 100px 10px;">
										...
										<div width="100px" height="20px">
											...
											<!--  <input name="colleagesname"
												...
												-->
											<select name="colleagesname" id="s1"
										...
										<div width="100px" height="20px">
											...
											<select name="professionsname" id="s2"
												style="width:200px;height:30px;">
												<option></option>
											</select>
										...
										<div width="100px" height="20px">
											...
											<select name="classnamename" id="s3" onmouseout="getKCM()"
												style="width:200px;height:30px;">
												<option></option>
											</select>
										...
										<div width="100px" height="20px">
											<label for="name" style="font-size: medium"> 是否在校: </label>
											<!--<input
