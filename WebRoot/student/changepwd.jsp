...
<html lang="zh">
    <head>
        ...
        function checkAction(n){
    		if(n == 0){
    			document.formName.action="Student_changePwd?page=StudentLogin";
    			document.formName.submit();
    		}
    	}
        function showMessage(n){
        	if(n ==0){
	        	$("#errorInfo").html("不存在该学生信息！");
        	}
        	if(n == 1){
        ...
        function temp() {
			...
			var v4=$("#bsm_section_7_newpassword1").val();
			var v5=$("#bsm_section_7_newpassword2").val();
            ...
            <div class="row" style="height: 80%">
                <div class="container">
                        <div class="row bsm_767_padding_15 bsm_767_margin_top_50" style="text-align: center">
                            <h1 class="bsm_color_red bsm_uppercase bsm_amatic_font bsm_font_size_36 bsm_section_7_title bsm_1199_font_size_30" style="color: #23527c;font-family: 'KaiTi'">个人信息修改</h1>
                            <div class="work-progress">
                                ...
                                <form name="formName" action="" method="post">
                                    ...
                                    <div class="bsm_section_7_form_content" style="text-align: center">
                                        <input id="bsm_section_7_password" class="bsm_section_7_input bsm_font_size_14" type="password" name="bsm_section_7_password" placeholder="原密码">
                                        <label for="bsm_section_7_password">
                                            <img src="img/bsm_border_input.png" alt="" >
                                        </label>
                                    </div>
                                    <div class="bsm_section_7_form_content" style="text-align: center">
                                        <input id="bsm_section_7_newpassword1" class="bsm_section_7_input bsm_font_size_14" type="password" name="newpassword1" placeholder="新密码">
                                        <label for="bsm_section_7_newpassword1">
                                            <img src="img/bsm_border_input.png" alt="" >
                                        </label>
                                    </div>
                                    <div class="bsm_section_7_form_content" style="text-align: center">
                                        <input id="bsm_section_7_newpassword2" class="bsm_section_7_input bsm_font_size_14" type="password" name="newpassword2" placeholder="确认密码">
                                        <label for="bsm_section_7_newpassword2">
                                            <img src="img/bsm_border_input.png" alt="" >
                                        </label>
                                    </div>
                                    ...
                                    <button type="button" class="bsm_effect_slide_left bsm_section_7_submit bsm_font_size_14 bsm_uppercase" type="submit" name="bsm_section_7_submit_button" onclick="temp()" style="background-color: #23527c">
                                        <span id="tijiao" style="color: white;font-family: 'kaiti'">确认修改</span>
                                    </button>
                                </form>
                                </center>
                            </div>
